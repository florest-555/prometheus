...
export const CliComandoReestruturarMensagens = createI18nMessages({
  ...
  inicio: '\n[SYNC] Starting restructuring process...\n',
  erroDuranteReestruturacao: (erroMensagem: string) => `[ERR] Error during restructuring: ${erroMensagem}`,
  ...
  planoSugeridoFast: (origem: string, moverLen: number) => `[OK] Suggested plan (${origem}) FAST: ${moverLen} move(s)`,
  dryRunFast: 'Dry-run requested (--plan-only). (FAST MODE)',
  reestruturacaoConcluidaFast: (moverLen: number) => `[OK] Restructuring completed: ${moverLen} moves. (FAST MODE)`,
  ...
  fallbackProblemasEstruturais: (qtd: number) => `[CONF] Restructuring based on ${qtd} structural problems found:`,
  ...
  reestruturacaoConcluida: (total: number, frase: string) => `[OK] Restructuring completed: ${total} ${frase}.`,
  ...
  inicio: '\n[SYNC] Iniciando processo de reestruturação...\n',
  erroDuranteReestruturacao: (erroMensagem: string) => `[ERR] Erro durante a reestruturação: ${erroMensagem}`,
  ...
  planoSugeridoFast: (origem: string, moverLen: number) => `[OK] Plano sugerido (${origem}) FAST: ${moverLen} movimentação(ões)`,
  dryRunFast: 'Dry-run solicitado (--somente-plano). (FAST MODE)',
  reestruturacaoConcluidaFast: (moverLen: number) => `[OK] Reestruturação concluída: ${moverLen} movimentos. (FAST MODE)`,
  ...
  fallbackProblemasEstruturais: (qtd: number) => `[CONF] Reestruturando baseado em ${qtd} problemas estruturais encontrados:`,
  fallbackLinhaOcorrencia: (tipo: string, arq: string, msg: string) => `  [${tipo}] ${arq}: ${msg}`,
  ...
  reestruturacaoConcluida: (total: number, frase: string) => `[OK] Reestruturação concluída: ${total} ${frase}.`,
