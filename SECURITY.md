...
- **GitHub Security Advisories**: Use o [formulário de advisories do GitHub](https://github.com/i-c-l-org/prometheus/security/advisories/new) para relatar vulnerabilidades de forma privada.
...
- **E-mail**: Contate o mantenedor diretamente via e-mail (consulte o perfil do GitHub de [@i-c-l-org](https://github.com/i-c-l-org) para obter o e-mail).
...
- **Mantenedor**: Italo C Lopes ([@i-c-l-org](https://github.com/i-c-l-org))
- **Repositório**: [https://github.com/i-c-l-org/prometheus](https://github.com/i-c-l-org/prometheus)
